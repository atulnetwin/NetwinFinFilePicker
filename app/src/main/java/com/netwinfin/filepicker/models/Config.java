...
public final class Config {
    ...
    public static com.netwinfin.filepicker.models.Config getInstance(){
        return InstanceHolder.INSTANCE;
    }

    public static com.netwinfin.filepicker.models.Config getCleanInstance(){
        com.netwinfin.filepicker.models.Config config = getInstance();
        config.reset();
        return config;
    }
    ...
    private static final class InstanceHolder{
        private static final com.netwinfin.filepicker.models.Config INSTANCE = new com.netwinfin.filepicker.models.Config();
    }
}
