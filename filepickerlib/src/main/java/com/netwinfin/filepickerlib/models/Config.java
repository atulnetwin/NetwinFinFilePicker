package com.netwinfin.filepickerlib.models;
...
public final class Config {
    ...
    public static com.netwinfin.filepickerlib.models.Config getInstance(){
        return InstanceHolder.INSTANCE;
    }

    public static com.netwinfin.filepickerlib.models.Config getCleanInstance(){
        com.netwinfin.filepickerlib.models.Config config = getInstance();
        config.reset();
        return config;
    }
    ...
    private static final class InstanceHolder{
        private static final com.netwinfin.filepickerlib.models.Config INSTANCE = new com.netwinfin.filepickerlib.models.Config();
    }
}
